                                    ...
                                    foreach ($data as $n => $v) :
                                        ...
                                        printf(
                                            '<tr class="%1$s">
                                                ...
                                                <td>%6$s</td>
                                                <td>%7$s</td>
                                                <td style="width: 10px"><a href="#TB_inline?&width=500&height=250&inlineId=settings-in-code" class="thickbox" title="%8$s"><span class="dashicons dashicons-editor-code"></span></a></td>
                                            </tr>',
