...
if (!class_exists('Wetory_Support_Template_Loader')) {

    /**
     * Template Loader.
     *
     * Class for loading template files provided by plugin and can be overriden 
     * in current theme. Code used from template loader provided by Gary Jones
     * https://github.com/GaryJones/Gamajo-Template-Loader. It is originally 
     * designed to be extended in plugin class, but I don't want to require two
     * files so used is as plugin class directly.
     * 
    ...
    class Wetory_Support_Template_Loader extends Wetory_Support_Singleton {
         ...
         * @var string
         */
        protected $filter_prefix = 'wetory_support';
         ...
         * @var string
         */
        protected $plugin_directory = WETORY_SUPPORT_PATH;
